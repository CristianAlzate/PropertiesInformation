...
namespace Infrastructure.Persistence.Base
{
        ...
        where TContext : DbContext, new()
    {
        ...
        public async Task CommitAsync(bool acceptAllChangesOnSuccess, CancellationToken cancellationToken = default) => await DbContext.SaveChangesAsync(acceptAllChangesOnSuccess, cancellationToken);
    }
}
